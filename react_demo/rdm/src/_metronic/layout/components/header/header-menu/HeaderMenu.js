            ...
            <li
                ...
                <div className="menu-submenu menu-submenu-classic menu-submenu-left">
                    <ul className="menu-subnav">
                        {/*begin::2 Level*/}
                        <li
                            className={`menu-item menu-item-submenu ${getMenuItemActive('/rdm')}`}
                            data-menu-toggle="hover"
                            aria-haspopup="true"
                        >
                            <NavLink className="menu-link menu-toggle" to="/rdm">
                                <span className="menu-text">
                                    eCommerce
                                </span>
                                <i className="menu-arrow" />
                            ...
                            <div className={`menu-submenu menu-submenu-classic menu-submenu-right`}>
                                <ul className="menu-subnav">
                                    {/*begin::3 Level*/}
                                    <li className={`menu-item ${getMenuItemActive('/rdm/customers')}`}>
                                        <NavLink className="menu-link" to="/rdm/customers">
                                            <i className="menu-bullet menu-bullet-dot"><span /></i>
                                    ...
                                    {/*begin::3 Level*/}
                                    <li className={`menu-item ${getMenuItemActive('/rdm/agreements')}`}>
                                        <NavLink className="menu-link" to="/rdm/agreements">
                                            <i className="menu-bullet menu-bullet-dot"><span /></i>
